...
class EditarNombrePrograma : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_salir_Programa.setOnClickListener{
            abrirActividadParametros(AniadirProgramas::class.java,idsoact)
        }
        ...
        btn_actualizar_Programa.setOnClickListener{
            arreglo[idsoact].programas[idpro]=inputNuevoNombre.text.toString()
            abrirActividadParametros(AniadirProgramas::class.java,idsoact)
        }
    }
    ...
    fun abrirActividadParametros(
        ...
        intentExplicito.putExtra("idSO",id+1)
